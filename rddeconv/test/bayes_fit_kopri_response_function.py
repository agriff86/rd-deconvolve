...
"""
Work out the response function of the detector in KSG station (KOPRI programme) 
"""
...
def dilate_bool(b, passes=1):
    """
    dilate a boolan mask so that output[n] is true if input[n-1], input[n], input[n+1] are true
    """
    out = b.copy()
